...
bibliography: "`r file.path(system.file(package='iscb2021tidytranscriptomics', 'vignettes'), 'tidytranscriptomics.bib')`"
vignette: >
...
We will use RStudio Cloud during the iscb workshop. After the workshop, if you want to install on your own computer, see instructions [here](https://tidytranscriptomics-workshops.github.io/iscb2021_tidytranscriptomics/index.html#workshop-package-installation). 

Alternatively, you can view the material at the workshop webpage [here](https://tidytranscriptomics-workshops.github.io/iscb2021_tidytranscriptomics/articles/tidytranscriptomics.html). 
...
```{r}
BRCA <- iscb2021tidytranscriptomics::BRCA 
BRCA
```
...
```{r}
pbmc <- iscb2021tidytranscriptomics::pbmc_mito_info_all_datasets
```
...
# Aggregate
pbmc_bulk <-
  iscb2021tidytranscriptomics::pbmc %>%
  iscb2021tidytranscriptomics::aggregate_cells(file)
```
...
```{r}
pbmc_seurat <- iscb2021tidytranscriptomics::pbmc_seurat
```
...
If you want to suggest improvements for this workshop or ask questions, you can do so as described [here](https://github.com/tidytranscriptomics-workshops/iscb2021_tidytranscriptomics/blob/master/CONTRIBUTING.md).
